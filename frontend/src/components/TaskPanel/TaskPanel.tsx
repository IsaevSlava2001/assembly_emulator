  ...
  return (
    <Card className="glass-card p-6">
      <div className="flex items-center justify-between mb-6">
        <h5 className="text-xl font-bold text-gray-900">Задания</h5>
      ...
      {state.currentTask && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <h4 className="text-lg font-semibold text-blue-900 mb-2">{state.currentTask.title}</h4>
          <p className="text-blue-800 text-sm leading-relaxed">{state.currentTask.description}</p>
